...
public class PretWebAdminLoginController {
	...
	public void btnPretLaunchWebAdminClicked(Event e) {
		...
		try {
			...
			btnPretLaunchWebAdmin.getStyleClass().remove("success");
			btnPretLaunchWebAdmin.getStyleClass().add("danger");
			return;
		}
		ControllerUtils.showStages(getParentStage());
		btnPretLaunchWebAdmin.getStyleClass().remove("danger");
	...
	public void btnPretLogonWebAdminClicked(Event e) {
		...
		try {
			...
			*/
			...
			ControllerUtils.showStages(getParentStage());
			btnPretLogonWebAdmin.getStyleClass().remove("success");
			btnPretLogonWebAdmin.getStyleClass().add("danger");
			return;			
		}
		ControllerUtils.showStages(getParentStage());
		btnPretLogonWebAdmin.getStyleClass().remove("danger");
